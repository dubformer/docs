...
<ParamField body="pronunciationGlossaryId" type="string">
  ID of a pronunciation glossary to be used for this project. Pass empty string to remove.
</ParamField>
...
<Note>
  Translation, voices and pronunciation glossaries must exist and belong to your organization if provided. Pass an empty string to remove an existing glossary assignment.
</Note>
