...
<ParamField body="stringVariables" type="array">
  Array of key-value pairs for storing project metadata. Pass this to update or replace existing metadata.
...
curl -X PATCH \
  ...
  -d '{
    ...
    "voicesGlossaryId": "",
    "stringVariables": [
      { "key": "storyTitleId", "value": "67890" },
      { "key": "updatedBy", "value": "api-user" }
    ]
  }'
```
